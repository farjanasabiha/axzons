...
export default function Badge() {
  return (
    <section className="py-8 px-10  bg-[#f3fff0]">
      <div className=" flex flex-col  space-y-4 xl:space-y-0 xl:flex-row items-center md:px-10 space-x-4 container mx-auto md:max-w-[60%] py-4 border-2  border-primary rounded-xl">
